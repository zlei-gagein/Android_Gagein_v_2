...
public class JointVenturesAdapter extends BaseAdapter {
	
	private Context mContext;
	private APIHttp mApiHttp;
	private List<Company> jointVentures;
	
	public JointVenturesAdapter(Context mContext, Company mCompany) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final Company mCompany = jointVentures.get(position);
