...
public class SuggestedCompanyAdapter extends BaseAdapter{
	...
	public SuggestedCompanyAdapter(Context mContext, List<Company> suggestedCompanies) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_suggested_company, null);
			...
			if (CommonUtil.isTablet(mContext)) viewHolder.similar = (TextView) convertView.findViewById(R.id.contactName);
		...
		if (CommonUtil.isTablet(mContext))  viewHolder.similar.setText(mCompany.sourceText);
