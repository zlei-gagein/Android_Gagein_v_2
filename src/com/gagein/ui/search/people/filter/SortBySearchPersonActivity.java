...
public class SortBySearchPersonActivity extends BaseActivity implements OnItemClickListener{
	...
	protected void initData() {
		...
		sortBy = mFilters.getSortByFromContact();
	...
	private void setResultToActivity() {
		...
		intent.setClass(mContext, SearchPersonActivity.class);
